    ...
    <nav className=" w-full z-50 shadow-md bg-gray-950 bg-opacity-70 backdrop-blur-md">
      <div className=" flex justify-between items-center px-8 py-4 md:fixed md:w-full text-white">
        ...
        <ul className="hidden sm:flex items-center space-x-6 font-urbanist font-light ml-auto">
          ...
          <li>
            <a href="#services" className="hover:text-yellow-500 text-white">Services</a>
          </li>
          <li>
            <a href="#portfolio" className="hover:text-yellow-500 text-white">Projects</a>
          </li>
          <li>
            <div className="inline-flex items-center gap-1 px-2 py-0.5 bg-yellow-500 rounded-full group hover:bg-white transition-colors">
              <a
                href="#contact"
                className="text-white font-bold animate-pulse group-hover:text-yellow-500"
              >
                Connect
              </a>
      ...
      {isOpen && (
        <ul className="sm:hidden flex flex-col px-8 py-4 space-y-2 bg-gray-950 text-white">
          <li>
            <a
              href="#home"
              className="hover:text-yellow-500 block"
  ...
  return (
    ...
    >
      ...
      <div className="flex space-x-4">
        ...
        <a
          href="#contact"
          className="border border-yellow-500 text-yellow-500 px-6 py-3 rounded-lg font-semibold hover:bg-yellow-500 hover:text-gray-900 transition animate-pulse"
        >
          Start a Project
        </a>
      </div>
